...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			this.fnRecordsTotal = function ()
			{
				if ( this.oFeatures.bServerSide ) {
					return parseInt(this._iRecordsTotal, 10);//dalibor
				} else {
			...
			{
				if ( this.oFeatures.bServerSide ) {
					return parseInt(this._iRecordsDisplay, 10);//dalibor
				} else {
			...
			this.oLanguage = {
				...
				"sLengthMenu": "Prikaži _MENU_ zahtjeva na stranici",
				"sZeroRecords": "No matching records found",
				"sEmptyTable": "No data available in table",
				"sInfo": "Prikaz _START_ do _END_ od ukupno _TOTAL_ zahtjeva",
			...
			this._iDisplayLength = 25;//dalibor
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" class="input2" />';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select class="select2" size="1" '+sName+'>';
			var i, iLen;
